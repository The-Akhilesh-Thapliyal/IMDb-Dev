    ...
    return (
        <div className="max-w-6xl mx-auto space-y-4 p-4">
            ...
            <p className="text-justify">
                Greetings to our movie database website! We are a group of dedicated movie lovers united to establish a comprehensive hub catering to all your movie-related requirements.
            </p>

            <p className="text-justify">
                Our site aims to offer an extensive movie database featuring films globally, inclusive of recent news, reviews, and trailers. The database is regularly updated with new releases, ensuring access to the latest in cinema. Search movies by title, director, actor, genre, or release date for the ideal choice on any occasion.
            </p>
